 ...
 * @author enioj
 */
public class TicketAvailabilityRQ {
    ...
    public TicketAvailabilityRQ() {
    }

    public TicketAvailabilityRQ(String start, String end, String occupancy, String destination, String hotel) {
        this.start = start;
        this.end = end;
