...
public class ApiExperience {
    ...
    public ApiExperience(String key) {
        this.key = key;
    }

    public ApiExperience(String key, String name, String code, Date date, String description, Boolean unique, ApiImage image, Boolean onRequest, String provider, ApiCoordinates coordinates) {
        this.key = key;
        this.name = name;
        this.code = code;
        this.date = date;
