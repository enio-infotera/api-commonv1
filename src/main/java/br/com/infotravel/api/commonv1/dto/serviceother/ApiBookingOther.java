...
public class ApiBookingOther {
    ...
    public ApiBookingOther() {
    }

    public ApiBookingOther(ApiServiceOther other, Date dateSelected, List<ApiName> names) {
        this.other = other;
        this.dateSelected = dateSelected;
        this.names = names;
    }

    public ApiBookingOther(List<ApiLocator> locators, ApiServiceOther other, List<ApiName> names, List<ApiFare> fares, String provider, List<ApiPolicy> policies, ApiCancellationPolicy cancellationPolicies, BookingStatus status, BookingStatus providerStatus) {
