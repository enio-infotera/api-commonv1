...
public class ApiBookingInsurance {
    ...
    public ApiBookingInsurance() {
    }

    public ApiBookingInsurance(ApiInsurance insurance, Date dateSelected, List<ApiName> names) {
        this.insurance = insurance;
        this.names = names;
        this.dateSelected = dateSelected;
    }

    public ApiBookingInsurance(List<ApiLocator> locators, ApiInsurance insurance, List<ApiName> names, String provider, List<ApiPolicy> policies, ApiCancellationPolicy cancellationPolicies, BookingStatus status) {
