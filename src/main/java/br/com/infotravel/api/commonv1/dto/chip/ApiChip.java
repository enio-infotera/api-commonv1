...
public class ApiChip {
    ...
    public ApiChip(String key) {
        this.key = key;
    }

    public ApiChip(String key, String name, String code, Date date, String description, Boolean unique, ApiImage image, Boolean onRequest, String provider, ApiCoordinates coordinates) {
        this.key = key;
        this.name = name;
        this.code = code;
        this.date = date;
