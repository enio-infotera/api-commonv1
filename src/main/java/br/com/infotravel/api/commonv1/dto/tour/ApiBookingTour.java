...
public class ApiBookingTour {
    ...
    public ApiBookingTour() {
    }

    public ApiBookingTour(ApiTour tour, Date dateSelected, List<ApiName> names) {
        this.tour = tour;
        this.names = names;
        this.dateSelected = dateSelected;
    }

    public ApiBookingTour(List<ApiLocator> locators, ApiTour tour, List<ApiName> names, List<ApiFare> fares, String provider, List<ApiPolicy> policies, ApiCancellationPolicy cancellationPolicies, BookingStatus status, BookingStatus providerStatus) {
